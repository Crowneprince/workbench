...
def create_claimsreg_pivot(df):
    ...
    tb_claims_reg = tb_claims_reg.pivot_table(index='ClaimBands', columns='Year', values='ClaimsID', aggfunc='sum',
                                              fill_value=0, margins=True, margins_name='Total')  # Custom name for the margins row/column)

    # Define custom order for columns
    custom_order_columns = ['10K', '20K', '30K', '50K', '80K', '100K',
...
def create_validclaims_pivot(df):
    ...
    # Using pivot_table to transpose the DataFrame by 'Product'
    tb_valid_claims = tb_valid_claims.pivot_table(
        index='ClaimBands', columns='Year', values='PaidOpenClaims', aggfunc='sum', fill_value=0, margins=True, margins_name='Total')
...
def create_claimsloss_pivot(df):
    ...
    # Using pivot_table to transpose the DataFrame by 'Product'
    tb_claims_loss = tb_claims_loss.pivot_table(
        index='ClaimBands', columns='Year', values='ClaimsLoss', aggfunc='sum', fill_value=0, margins=True, margins_name='Total')
...
def create_numinj_pivot(df):
    ...
    # Using pivot_table to transpose the DataFrame by 'Product'
    tb_no_injured = tb_no_injured.pivot_table(
        index='ClaimBands', columns='Year', values='Injured', aggfunc='sum', fill_value=0, margins=True, margins_name='Total')
...
def create_grossclaims_pivot(df):
    ...
    # Using pivot_table to transpose the DataFrame by 'Product'
    tb_gross_claim_valid = tb_gross_claim_valid.pivot_table(
        index='ClaimBands', columns='Year', values='GrossClaimValid', aggfunc='sum', fill_value=0, margins=True, margins_name='Total')
...
def create_avgclaiminj_pivot(df):
    ...
    tb_avg_claim_inj = tb_avg_claim_inj.replace(
        [np.inf, -np.inf], np.nan).fillna(0).astype(int).reset_index()
...
def create_paidunder_pivot(df):
    ...
    # Using pivot_table to transpose the DataFrame by 'Product'
    tb_paid_under = tb_paid_under.pivot_table(
        index='ClaimBands', columns='Year', values='Underwriter', aggfunc='sum', fill_value=0, margins=True, margins_name='Total')
...
def create_legalclaims_pivot(df):
    ...
    # Using pivot_table to transpose the DataFrame by 'Product'
    tb_leg_claims = tb_leg_claims.pivot_table(
        index='ClaimBands', columns='Year', values='Total Claims Paid', aggfunc='sum', fill_value=0, margins=True, margins_name='Total')
...
def create_legalclaimsnoclaims_pivot(df):
    ...
    # Using pivot_table to transpose the DataFrame by 'Product'
    tb_leg_cost_only = tb_leg_cost_only.pivot_table(
        index='ClaimBands', columns='Year', values='LegalCostOnly', aggfunc='sum', fill_value=0, margins=True, margins_name='Total')
...
def create_amtlegalclaimsnoclaims_pivot(df):
    ...
    # Using pivot_table to transpose the DataFrame by 'Product'
    tb_only_leg_cost_amt = tb_only_leg_cost_amt.pivot_table(
        index='ClaimBands', columns='Year', values='OnlyLegalCostAmt', aggfunc='sum', fill_value=0, margins=True, margins_name='Total')
...
def create_legalcostpmt_pivot(df):
    ...
    # Using pivot_table to transpose the DataFrame by 'Product'
    tb_leg_cost_pmt = tb_leg_cost_pmt.pivot_table(
        index='ClaimBands', columns='Year', values='LegalClaimsPaid', aggfunc='sum', fill_value=0, margins=True, margins_name='Total')
...
def create_liabcostpmt_pivot(df):
    ...
    # Using pivot_table to transpose the DataFrame by 'Product'
    tb_liab_cost_pmt = tb_liab_cost_pmt.pivot_table(
        index='ClaimBands', columns='Year', values='LiabilityClaimsPaid', aggfunc='sum', fill_value=0, margins=True, margins_name='Total')
